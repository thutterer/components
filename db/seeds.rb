...
Component.create(quantity: 10, title:"BenQ X3000", supplier: suppliers.first, room: rooms.first, category: category[1])
Component.create(quantity: 5, title:"HP Laserjet 5L", supplier: suppliers[1], room: rooms.first, category: category[3])
Component.create(quantity: 20, title:"DELL 87", supplier: suppliers[2], room: rooms[1], category: category[4])
Component.create(quantity: 1, title:"DELL 500", supplier: suppliers[2], room: rooms[2], category: category[2])
